...
export default ({
  ...
  return (
    <Modal
      ...
      buttonClassName={`w-full min-w-max h-20 bg-slate-50 hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800 rounded-xl shadow dark:shadow-slate-500 ${disabled ? 'cursor-not-allowed' : ''} grid grid-cols-3 sm:grid-cols-3 items-center gap-2 py-2 px-3`}
