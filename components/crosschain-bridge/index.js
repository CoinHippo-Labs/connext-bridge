...
export default function CrosschainBridge() {
  ...
  return (
    <div className="grid grid-flow-row grid-cols-1 lg:grid-cols-8 items-start gap-4">
      ...
      <div className="col-span-1 lg:col-span-4 flex flex-col items-center justify-center space-y-2 sm:space-y-3 my-8 sm:my-12">
          ...
          {isSupport() && balances_data?.[swapConfig.fromChainId]/* && typeof estimatedFees === 'number'*/ && typeof swapConfig.amount === 'number' ?
            ...
            web3_provider ?
              ...
              <Wallet
                ...
                buttonConnectClassName="w-full bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-600 dark:hover:bg-indigo-700 rounded-lg shadow-lg flex items-center justify-center text-base sm:text-lg font-semibold space-x-2.5 py-4 px-3"
              />
          }
