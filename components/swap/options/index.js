...
import { DEFAULT_PERCENT_SWAP_SLIPPAGE } from '../../../lib/config'
import { isNumber } from '../../../lib/number'
import { toArray, numberToFixed, switchColor } from '../../../lib/utils'

export default ({ disabled = false, applied = false, initialData, onChange }) => {
                          ...
                          <DebounceInput
                            ...
                            onChange={
                              e => {
                                ...
                                value = name === 'slippage' && (value <= 0 || value > 100) ? DEFAULT_PERCENT_SWAP_SLIPPAGE : value
                                setData({ ...data, [name]: isNumber(value) ? parseFloat(numberToFixed(value, 6)) : value })
                              }
                            }
